...
> **Note**: See [AGENTS.md](AGENTS.md) for context on how to use these Anthropic official skills in Cursor (vs Claude Code).
...
## Meta Skills
- **skill-packager** - Package and validate skills for external distribution (for creating skills within Rebel, use `write-skill` instead)
...
**Note**: Any Python scripts created for skills should be placed in `scripts/` (default to the primary zone's `scripts/` folder).
