...
**Language preference:** JavaScript/Node.js is preferred since Rebel is an Electron app that bundles Node.js, making scripts work out of the box for all users (including Windows) without additional runtime installation.
...
EXAMPLE_SCRIPT_JS = '''#!/usr/bin/env node
/**
...
EXAMPLE_SCRIPT_PY = '''#!/usr/bin/env python3
"""
...
def init_skill(skill_name, path):
    ...
    try:
        # Create scripts/ directory with example scripts (JS preferred, Python alternative)
        scripts_dir = skill_dir / 'scripts'
        scripts_dir.mkdir(exist_ok=True)
        
        # JavaScript example (preferred)
        example_script_js = scripts_dir / 'example.js'
        example_script_js.write_text(EXAMPLE_SCRIPT_JS.format(skill_name=skill_name))
        example_script_js.chmod(0o755)
        print("✅ Created scripts/example.js (preferred)")
        
        # Python example (alternative)
        example_script_py = scripts_dir / 'example.py'
        example_script_py.write_text(EXAMPLE_SCRIPT_PY.format(skill_name=skill_name))
        example_script_py.chmod(0o755)
        print("✅ Created scripts/example.py (alternative)")
