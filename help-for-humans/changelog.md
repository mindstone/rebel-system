...
<!-- detail: DeepSeek, MiniMax and Z.ai/GLM models now use only providers with infrastructure in the US or EU when routed through OpenRouter. Rebel's default OpenRouter choices for working, thinking and supporting tasks were also updated to the latest generation. -->
