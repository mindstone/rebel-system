...
- **"Still setting up" is no longer mistaken for "no"** — in the first moments after an update, while Rebel moves your old safety settings into your Safety Rules, an action that slipped past the "initializing" notice could be held as if your rules had turned it down. It's now handled like any safety check that couldn't finish: Rebel checks it again by itself shortly after, and the card no longer blames your rules for something they never saw.
