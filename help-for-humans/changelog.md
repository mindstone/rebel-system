...
<!-- feature: inbox-read-contract | detail: rebel_inbox_list and rebel_inbox_query share one read-filter contract over the /inbox/query backend, so an argument shape accepted by one is accepted by the other; super-mcp's argument-shape discriminator is promoted to a Sentry tag. (5924581f36, REBEL-61R) -->
