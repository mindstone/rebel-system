...
- **Your Safety Rules take orders from your computer only** — your cloud now accepts changes to your Safety Rules only from the computer that set it up, not from anything else that happens to have its access key. If you've connected a second computer to the same cloud, rules you save there stay on that computer, and Settings → Cloud says so rather than leaving you to find out.
